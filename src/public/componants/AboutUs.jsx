            ...
            <div className="container px-5 mx-auto flex flex-col md:flex-row  justify-between gap-12">
                ...
                <div className="md:w-1/2 relative h-auto flex">
                    <img
                        ...
                        alt="About Us"
                        className="w-full h-auto relative z-10 rounded-lg shadow-2xl transform hover:scale-105 transition-transform duration-300  md:h-[400px]"
                    />
                </div>
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                    ...
                    {/* Call to Action */}
                    <Link to={"/about"}>
                        <button className="bg-black w-32 text-white py-2 px-2 rounded-sm mt-5  transition-all">
                            Learn More
                        </button>
                    </Link>
                </div>
